  ...
  return (
    <div className='home-pages container mx-auto'>
        <section className='home-section-one mt-3'>
            <div className="flex">
                <div className="gift-box basis-1/10 me-5 bg-white rounded shadow-2xl h-[102.5px] max-h-[102.5px]">
               <div className='bg-[#EF6D8D] w-[100px] h-full flex justify-center items-center rounded-bl rounded-tl'>
        ...
        <section className='home-section-four mt-3'>
            <div className="flex">
                <div className="gift-box basis-1/10 me-5 bg-white rounded shadow-2xl max-h-[102.5px]">
               <div className='bg-[#EF6D8D] w-[100px] h-full flex justify-center items-center rounded-bl rounded-tl'>
