          ...
          <div className="flex space-x-4">
            {editMode ? (
              <>
                ...
                <button 
                  onClick={handleSave}
                  className="px-4 py-2 bg-pink-600 rounded-md text-sm font-medium text-white hover:bg-pink-700"
                >
                  Save Changes
                </button>
              </>
              ...
              <button 
                ...
                className="px-4 py-2 bg-pink-600 rounded-md text-sm font-medium text-white hover:bg-pink-700 flex items-center"
              >
          ...
          <div className="lg:col-span-1">
            <div className="bg-white shadow rounded-lg overflow-hidden">
              <div className="p-6 text-center">
                ...
                <p className="text-pink-600">{userData.role}</p>
                <p className="text-gray-500 text-sm mt-1">{userData.company}</p>
              </div>
              <div className="border-t border-gray-200 px-6 py-4">
                <div className="flex items-center justify-between">
                  <span className="text-sm font-medium text-gray-500">Tenant ID</span>
                  <span className="text-sm text-gray-900">{userData.tenant}</span>
                </div>
              </div>
              <div className="border-t border-gray-200 px-6 py-4">
                ...
                <button className="w-full flex items-center justify-center px-4 py-2 text-sm font-medium text-red-600 hover:bg-gray-100 mt-2">
              ...
              <div className="px-6 py-5">
                <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                  <div>
                    ...
                    <div className="flex items-center">
                      <span className="bg-gray-100 px-3 py-2 rounded-md text-sm font-mono">{userData.tenant}</span>
                    </div>
                  </div>
                  <div>
